...
'RD Hover' => array(
	...
	'elements' => array(
			...
			'description' => __('If you want to enable this awesome features, you need to buy pro version from here <a href="http://demo.wpexpert24.com/rd-hover-effect/?download=rd-hover-effects">RD Hover Effects Pro</a>', 'vp_textdomain'),
			'status' => 'error',
				),
